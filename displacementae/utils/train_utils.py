...
def run(mode='autoencoder',repr='blockrepr'):
    ...
    Args:
        ...
        repr (str): group representation, defaults to 'blockrepr'.
            ...
            'prodrepr' : actions are represented by product of rotation 
                    matrices of 2D planes generated by pairs of canonical 
                    base vectors.
    """
    # parse commands
    if mode == 'autoencoder':
    ...
    # setup dataset
    dhandler, dloader = data_utils.setup_data(config) # TODO make a 
                                                      # custom latent space
    # setup models

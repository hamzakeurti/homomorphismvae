...
grid = {
    ...
    ### Dataset options ###
    'dataset': ['obj3d'],
    'data_root': ['/fast/hkeurti/datasets/obj3d/bunny_rots_cols_300k_mat.hdf5'],
    'n_steps': [2],
    'rotate_actions':[0],
    # 'resample':[True],
    # 'resample_every':[2],
    ...
    'latent_loss_weight':[10,100,200,400,800,1000,2000,5000],
    'latent_loss':[True],
    ...
    ### Evaluation options ###
    'val_epoch' : [10],
    'wandb_project_name' : ['icmlcr_sblock_bunny_rots_cols_1.0'],
    'log_wandb':[True],
    'checkpoint':[False],
    ...
    'grp_loss_on':[True],
    'grp_loss_weight':[0.01, 0.05, 0.1, 0.5, 1, 5, 10, 100],
    'regularize_algebra':[False, True],
